...
import HtmlTemplate from "./page-ratingList.html";

/**
 * Klasse PageList: Stellt die Listenübersicht zur Verfügung
 */
export default class PageRatingList extends Page {
    /**
     * Konstruktor.
     *
    ...
    async init() {
        ...
        for (let index in data) {
            ...
            liElement.querySelector(".action.edit").addEventListener("click", () => location.hash = `#/editRating/${dataset._id}`);
    ...
    async _askDelete(id) {
        ...
        // Datensatz löschen
        try {
            this._app.backend.fetch("DELETE", `/rating/${id}`);
        } catch (ex) {
